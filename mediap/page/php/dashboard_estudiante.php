...
<body>
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="dashboard_estudiante.phps">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-left">
                        <h1><?php echo "Bienvenido estudiante: ". $_SESSION['user_name']; // Muestra el nombre del estudiante en la página ?></h1>
                        ...
                        <a class="btn btn-danger" href="../html/explora.html">Explora</a>
                    </div>
