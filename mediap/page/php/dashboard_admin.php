...
<head>
    ...
    <title>Institución Educativa Carlos Pérez Mejía - Dashboard Administrador</title>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-left">
                        <h1><?php echo "Bienvenido administrador: " . $_SESSION['user_name']; // Muestra el nombre del administrador ?></h1>
                        <h2>I.E CARLOS PEREZ MEJIA</h2>
                        <p>Panel administrativo para la gestión integral de la institución educativa</p>
                    </div>
