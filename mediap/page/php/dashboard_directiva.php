...
<head>
    ...
    <title>Institución Educativa Carlos Pérez Mejía - Dashboard Directiva</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reportes_directiva.php">Reportes de Gestión</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="estrategias.php">Estrategias Educativas</a>
                </ul>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-left">
                        <h1><?php echo "Bienvenida directiva: " . $_SESSION['user_name']; // Muestra el nombre de la directiva ?></h1>
                        <h2>I.E CARLOS PEREZ MEJIA</h2>
                        <p>Panel de gestión para las decisiones y estrategias educativas de la institución</p>
                    </div>
